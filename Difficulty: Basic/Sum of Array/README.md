<h2><a href="https://www.geeksforgeeks.org/problems/sum-all-array-elements/1?page=2&category=Arrays&difficulty=Basic,Easy,Medium&status=solved,unsolved,attempted&sortBy=difficulty">Sum of Array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong>, return the <strong>sum </strong>of all elements of arr.</span></p>
